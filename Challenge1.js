...
function prepareGifts(gifts) {
    ...
    //Creamos una constante llamada set y le pasamos el atributo gifts
    //creamos un New Set para eliminar duplicados como se nos pide
    // y lo volvemos a transformar en un array con Array.from
    const set = Array.from(new Set(gifts))


    //retornamos el set.sort para ordenar de forma ascendente
    //habiamos transformado el set en array nuevamente ya que no se podia
    //ocupar sort sin ser un array
